...
using n0tYoutubeDL.Core.Helpers;
using n0tYoutubeDL.Core.Metadata;
using n0tYoutubeDL.Core.Options;
using System.Runtime.InteropServices;

namespace n0tYoutubeDL.Core
{
    /// <summary>
    /// A class providing methods for downloading videos using youtube-dl.
    /// </summary>
    public class n0tYoutubeDL
    {
        ...
        /// </summary>
        public string YoutubeDLPath { get; set; } = (RuntimeInformation.IsOSPlatform(OSPlatform.Linux) | RuntimeInformation.IsOSPlatform(OSPlatform.OSX)) ? "youtube-dl": "youtube-dl.exe";

        /// <summary>
        /// Path to the Python executable.
        /// </summary>
        public string PythonPath { get; set; } =  (RuntimeInformation.IsOSPlatform(OSPlatform.Linux) | RuntimeInformation.IsOSPlatform(OSPlatform.OSX)) ? "python3" : "python3.exe";

        /// <summary>
        /// Path to the FFmpeg executable.
        /// </summary>
        public string FFmpegPath { get; set; } = (RuntimeInformation.IsOSPlatform(OSPlatform.Linux) | RuntimeInformation.IsOSPlatform(OSPlatform.OSX)) ? "ffmpeg" : "ffmpeg.exe";
        /// <summary>
        ...
        public n0tYoutubeDL(byte maxNumberOfProcesses = 4)
        {
