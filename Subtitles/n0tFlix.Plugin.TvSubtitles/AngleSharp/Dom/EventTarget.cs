namespace AngleSharp.Dom
{
    ...
    public abstract class EventTarget : IEventTarget
    {
        ...
        {
            if (ev == null || string.IsNullOrEmpty(ev.Type) || ((ev.Flags & EventFlags.Dispatch) == EventFlags.Dispatch) || ((ev.Flags & EventFlags.Initialized) != EventFlags.Initialized))
            {
        ...
        #endregion Event Listener Structure
    }
}